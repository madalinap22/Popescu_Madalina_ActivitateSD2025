...
//	if (indexSt < h.dim && h.vector[indexSt].zile > h.vector[indexRad].zile) { //maxheap
//		indexRad = indexSt;
//	}
...
//
//	printf("\n\nExtragere 1 element_metoda 2 -----------------");
//	Dispozitiv elemExtras2 = extrageDispozitiv(&h);
//	afisareHeap(h);
//
//	printf("\n\nAfisare element extras -----------------");
//	afisareDispozitiv(elemExtras2);
//
//
//
//	dezalocare(h);
