...
//
//}
////conversie LS (am deja nod de ls)
...
//	}
//}
//Nod* conversieLS(HT tabela, const char* denCautata) {
//	Nod* cap = NULL;
//	if (tabela.vector) {
//		for (int i = 0; i < tabela.dim; i++) {
//			if (tabela.vector[i]) {
...
//				while (aux) {
//					if (strcmp(aux->info.status, denCautata) == 0) {
//						cap = inserareFinal(cap, aux->info);
//					}
//					aux = aux->next;
//				}
//			}
...
//
//typedef struct LD {
//	NodLD* prim; //nod de lista dubla
//	NodLD* ultim;
//}LD;
//
//LD adaugaLD(LD lista, Cladire c) {
...
//}
//
//LD conversieLD(HT tabela, const char* denCautata) {
//	LD lista;
//	lista.prim = NULL;
//	lista.ultim = NULL;
//
...
//		for (int i = 0; i < tabela.dim; i++) {
//			if (tabela.vector[i]) {
//				NodLD* aux = tabela.vector[i];
//				
//				while (aux) {
//					if (strcmp(aux->info.status, denCautata) == 0) {
//						lista = adaugaLD(lista, aux->info);
//					}
//					aux = aux->next;
//				}
//			}
...
//
//	printf("\n\nConversie LS: ");
//	Nod* cap = conversieLS(tabela, "Expertizata");
//	afisareLS(cap);
//
//	printf("\n\nConversie LD: ");
//	LD lista;
//	lista.prim = NULL;
//	lista.ultim = NULL;
//	lista = conversieLD(tabela, "Expertizata");
//	afisareLD(lista);
//
//	dezalocare(tabela);
